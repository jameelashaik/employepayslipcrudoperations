		...
		//	employeslipList = CRUDOPerations.Employepayslip(req, res);
			...
			for(Employee e:employeesList)
			{
				 ...
				 out.print("<tr><td>"+e.getId()+"</td><td>"+e.getName()+"</td>" +
				 		"<td>"+e.getPancard()+"</td><td>"+e.getGrosstotal()+"</td><td>"+e.getDayspresent()+"</td> <td>"+e.getBasicpay()+"</td><td>"+e.getDa()+"</td><td>"+e.getHra()+"</td><td>"+e.getPf()+"</td><td>"+e.getPt()+"</td><td>"+e.getNetsalary()+"</td></tr>");  
